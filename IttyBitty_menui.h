...
#pragma region [MenUI] DEFINITION
	...
	public:
		...
		MenUI(CDWORD = 0, CBOOL = TRUE, FLASH_STRING = NULL, CBYTE = MENUI_DEFAULT_MENU_CAPACITY);
		MenUI(CBYTE, PPIUIINPUTSOURCE, CBYTE, PPIUIRENDERER, CDWORD = 0, CBOOL = TRUE, FLASH_STRING = NULL, CBYTE = MENUI_DEFAULT_MENU_CAPACITY);
