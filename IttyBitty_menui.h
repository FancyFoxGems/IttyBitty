...
#pragma region [MenUI] DEFINITION
	...
	public:
		...
		MenUI(PUINAVIGATIONCONTROLLER, PUIDISPLAYCONTROLLER, CBYTE, PPIMENUITEM, CBOOL = TRUE);
		MenUI(PUINAVIGATIONCONTROLLER, PUIDISPLAYCONTROLLER, CBYTE = MENUI_DEFAULT_MENU_CAPACITY, CBOOL = TRUE);
