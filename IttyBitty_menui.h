...
#pragma region [MenUI] DEFINITION
	...
	public:
		...
		MenUI(DWORD = 0, FLASH_STRING = NULL, CBYTE = MENUI_DEFAULT_MENU_CAPACITY);
		MenUI(CBYTE, PPIUIINPUTSOURCE, CBYTE, PPIUIRENDERER, DWORD = 0, FLASH_STRING = NULL, CBYTE = MENUI_DEFAULT_MENU_CAPACITY);
