...
#pragma region CUSTOM CHARACTER FLASH DATA DECLARATIONS
	...
	// Scrollbar icons
	EXTERN BYTE_P LCD_CHAR_SCROLLBAR_TOP[8];
	EXTERN BYTE_P LCD_CHAR_SCROLLBAR_BOTTOM[8];

	// Slider icons
	EXTERN BYTE_P LCD_CHAR_SLIDER_END_LEFT[8];
	EXTERN BYTE_P LCD_CHAR_SLIDER_END_RIGHT[8];
