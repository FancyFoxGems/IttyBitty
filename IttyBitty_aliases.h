...
#define TYPEDEF_PROGMEM_ALIAS(type_name, TYPE_ALIAS)					\
	typedef const type_name PROGMEM TYPE_ALIAS##_P, PROGMEM TYPE_ALIAS##_PROG, PROGMEM TYPE_ALIAS##_F, PROGMEM TYPE_ALIAS##_FLASH, 		\
		* const PROGMEM P##TYPE_ALIAS##_P, * const PROGMEM P##TYPE_ALIAS##_PROG, * const PROGMEM P##TYPE_ALIAS##_F, * const PROGMEM P##TYPE_ALIAS##_FLASH
...
#define TYPEDEF_ENUM_ALIASES_WITH_PROGMEM(type_name, TYPE_ALIAS)	TYPEDEF_ALIASES_WITH_PP_AND_PROGMEM(enum type_name, TYPE_ALIAS)

#define TYPEDEF_UNION_ALIASES(type_name, TYPE_ALIAS)				TYPEDEF_ALIASES_WITH_PP(union type_name, TYPE_ALIAS)
#define TYPEDEF_UNION_ALIASES_WITH_PROGMEM(type_name, TYPE_ALIAS)	TYPEDEF_ALIASES_WITH_PP_AND_PROGMEM(union type_name, TYPE_ALIAS)
...
#define TYPEDEF_CLASS_ALIASES_WITH_PROGMEM(type_name, TYPE_ALIAS)	TYPEDEF_ALIASES_WITH_PP_AND_PROGMEM(class type_name, TYPE_ALIAS)
...
typedef const void * CPTR, ** PCPTR, * PCVOID, ** PPCVOID, * PROGMEM PVOID_P, * PROGMEM PVOID_PROG, * PROGMEM PVOID_F, * PROGMEM PVOID_FLASH;
...
typedef const char * cstring, * CSTRING, * PROGMEM CSTRING_P, * PROGMEM CSTRING_PROG, * PROGMEM CSTRING_F, * PROGMEM CSTRING_FLASH;
...
typedef const wchar_t * WIDE_STRING_STRING_P PROGMEM,
	* PROGMEM UNICODE_STRING_P, * PROGMEM UNICODE_STRING_PROG, * PROGMEM UNICODE_STRING_F, * PROGMEM UNICODE_STRING_FLASH,
	* PROGMEM UNICODE16_STRING_P, * PROGMEM UNICODE16_STRING_PROG, * PROGMEM UNICODE16_STRING_F, * PROGMEM UNICODE16_STRING_FLASH;
