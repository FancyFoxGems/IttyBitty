...
#define TYPEDEF_PROGMEM_ALIAS(type_name, TYPE_ALIAS)					\
	typedef const type_name TYPE_ALIAS##_P, TYPE_ALIAS##_PROG, TYPE_ALIAS##_F, TYPE_ALIAS##_FLASH, 		\
		* const P##TYPE_ALIAS##_P, * const P##TYPE_ALIAS##_PROG, * const P##TYPE_ALIAS##_F, * const P##TYPE_ALIAS##_FLASH
...
#define TYPEDEF_ENUM_ALIASES(type_name, TYPE_ALIAS)					TYPEDEF_ALIASES_WITH_VOLATILE_AND_PP(enum type_name, TYPE_ALIAS)
#define TYPEDEF_ENUM_ALIASES_WITH_PROGMEM(type_name, TYPE_ALIAS)	TYPEDEF_ALIASES_WITH_VOLATILE_PP_AND_PROGMEM(enum type_name, TYPE_ALIAS)
#define TYPEDEF_ENUM_ALIASES_AS_VOLATILE(type_name, TYPE_ALIAS)		TYPEDEF_ALIASES_AS_VOLATILE_WITH_PP(enum type_name, TYPE_ALIAS)

#define TYPEDEF_UNION_ALIASES(type_name, TYPE_ALIAS)				TYPEDEF_ALIASES_WITH_VOLATILE_AND_PP(union type_name, TYPE_ALIAS)
#define TYPEDEF_UNION_ALIASES_WITH_PROGMEM(type_name, TYPE_ALIAS)	TYPEDEF_ALIASES_WITH_VOLATILE_PP_AND_PROGMEM(union type_name, TYPE_ALIAS)
#define TYPEDEF_UNION_ALIASES_AS_VOLATILE(type_name, TYPE_ALIAS)	TYPEDEF_ALIASES_AS_VOLATILE_WITH_PP(union type_name, TYPE_ALIAS)

#define TYPEDEF_CLASS_ALIASES(type_name, TYPE_ALIAS)				TYPEDEF_ALIASES_WITH_VOLATILE_AND_PP(class type_name, TYPE_ALIAS)
#define TYPEDEF_CLASS_ALIASES_WITH_PROGMEM(type_name, TYPE_ALIAS)	TYPEDEF_ALIASES_WITH_VOLATILE_PP_AND_PROGMEM(class type_name, TYPE_ALIAS)
#define TYPEDEF_CLASS_ALIASES_AS_VOLATILE(type_name, TYPE_ALIAS)	TYPEDEF_ALIASES_AS_VOLATILE_WITH_PP(class type_name, TYPE_ALIAS)
...
#define TYPEDEF_STRUCT_ALIASES(type_alias, lower_type_alias, UPPER_TYPE_ALIAS)												\
	...
	TYPEDEF_ALIASES_WITH_VOLATILE_AND_PP(struct EXPAND_CONCAT(_, type_alias), UPPER_TYPE_ALIAS)
#define TYPEDEF_STRUCT_ALIASES_WITH_PROGMEM(type_alias, lower_type_alias, UPPER_TYPE_ALIAS)									\
	typedef struct EXPAND_CONCAT(_, type_alias) EXPAND_CONCAT(EXPAND_CONCAT(_, lower_type_alias),_t), type_alias;			\
	TYPEDEF_ALIASES_WITH_VOLATILE_PP_AND_PROGMEM(struct EXPAND_CONCAT(_, type_alias), UPPER_TYPE_ALIAS)
#define TYPEDEF_STRUCT_ALIASES_AS_VOLATILE(type_alias, lower_type_alias, UPPER_TYPE_ALIAS)									\
...
typedef void VOID, * PTR, ** PPTR, * PVOID, ** PPVOID;
typedef const void * CPTR, ** PCPTR, * PCVOID, ** PPCVOID, * PVOID_P, * PVOID_PROG, * PVOID_F, * PVOID_FLASH;


TYPEDEF_ALIASES_WITH_VOLATILE_PP_AND_PROGMEM(bool, BOOL);
TYPEDEF_ALIASES_WITH_VOLATILE_PP_AND_PROGMEM(bool, BOOLEAN);
...
TYPEDEF_ALIASES_WITH_VOLATILE_PP_AND_PROGMEM(unsigned char, NYBBLE);

typedef unsigned char nybble;
...
typedef const char * cstring, * CSTRING, * CSTRING_P, * CSTRING_PROG, * CSTRING_F, * CSTRING_FLASH;
...
typedef const wchar_t * WIDE_STRING_STRING_P PROGMEM,
	* UNICODE_STRING_P, * UNICODE_STRING_PROG, * UNICODE_STRING_F, * UNICODE_STRING_FLASH,
	* UNICODE16_STRING_P, * UNICODE16_STRING_PROG, * UNICODE16_STRING_F, * UNICODE16_STRING_FLASH;
...
typedef long long int64, I64, verylong, VERYLONG, muchlong, MUCHLONG, somuchslong, SOMUCHSLONG;
