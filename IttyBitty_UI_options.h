...
// DISPLAY ADAPTER OPTIONS/CONSTANTS

// [LcdI2CUiRenderer] default options

#define MENUI_LCD_DEFAULT_STYLED_LINE_LEFT_GLYPH	LCD_SYMBOL_BACKWARD
#define MENUI_LCD_DEFAULT_STYLED_LINE_RIGHT_GLYPH	LCD_SYMBOL_FORWARD

#define MENUI_LCD_DEFAULT_MENU_ITEM_GLYPH			LCD_SYMBOL_BULLET
#define MENUI_LCD_DEFAULT_LIST_CHOICE_GLYPH			LCD_SYMBOL_BULLET
#define MENUI_LCD_DEFAULT_CURR_ITEM_GLYPH			LCD_SYMBOL_ARROW_RIGHT
#define MENUI_LCD_DEFAULT_SELECTION_GLYPH			LCD_SYMBOL_TRIANGLE_UP
#define MENUI_LCD_DEFAULT_MULTI_SELECTION_GLYPH		LCD_SYMBOL_MULTIPLICATION
