...
#pragma region [IStorable] DEFINITION
	...
	public:
		...
		VIRTUAL STORAGERESULT SaveAsBinary(RCISTORAGE) const = 0;
		VIRTUAL STORAGERESULT SaveAsString(RCISTORAGE) const = 0;

		VIRTUAL STORAGERESULT LoadFromBinary(RCISTORAGE) = 0;
		VIRTUAL STORAGERESULT LoadFromString(RCISTORAGE) = 0;
...
#pragma region [IStorage] DEFINITION
	...
	public:
		...
		VIRTUAL STORAGERESULT Open(RCSTORAGELOCATION, CBOOL = FALSE) = 0;

		VIRTUAL STORAGERESULT Seek(RCDWORD) = 0;

		VIRTUAL STORAGERESULT Write(PCBYTE, CSIZE) = 0;
		
		VIRTUAL STORAGERESULT Flush() = 0;

		VIRTUAL STORAGERESULT Close() = 0;
...
#pragma region [StorageBase] DEFINITION
	...
	public:
		...
		VIRTUAL STORAGERESULT Open(RCSTORAGELOCATION, CBOOL = FALSE);

		VIRTUAL STORAGERESULT Seek(RCDWORD);

		VIRTUAL STORAGERESULT Write(PCBYTE, CSIZE);
		
		VIRTUAL STORAGERESULT Flush();

		VIRTUAL STORAGERESULT Close();
