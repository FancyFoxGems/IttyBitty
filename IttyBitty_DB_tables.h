...
#pragma region [IDbTable] DEFINITION
	...
	public:
		...
		VIRTUAL CDBRESULT Create(CSIZE = DB_DEFAULT_INITIAL_ROWS_ALLOCATION) = 0;
		VIRTUAL CDBRESULT Drop() = 0;
		...
		VIRTUAL CDBRESULT Delete(CSIZE, CBOOL = TRUE) = 0;
		VIRTUAL CDBRESULT Truncate(CBOOL = TRUE) = 0;
	...
	protected:
		...
		VIRTUAL CSTORAGERESULT EraseData(RCDWORD, RCDWORD = 0, CBOOL = TRUE) = 0;
		VIRTUAL CSTORAGERESULT MoveData(RCLONG, RCDWORD = 0, CBOOL = FALSE, CBOOL = TRUE) = 0;
...
#pragma region [DbTable] DEFINITION
	...
	public:
		...
		VIRTUAL CDBRESULT Create(CSIZE = DB_DEFAULT_INITIAL_ROWS_ALLOCATION);
		VIRTUAL CDBRESULT Drop();
		...
		VIRTUAL CDBRESULT Delete(CSIZE, CBOOL = TRUE);
		VIRTUAL CDBRESULT Truncate(CBOOL = TRUE);
	...
	protected:
		...
		VIRTUAL CSTORAGERESULT EraseData(RCDWORD, RCDWORD = 0, CBOOL = TRUE);
		VIRTUAL CSTORAGERESULT MoveData(RCLONG, RCDWORD = 0, CBOOL = FALSE, CBOOL = TRUE);
...
#pragma region [IDbTableSet] DEFINITION
	...
	public:
		...
		VIRTUAL CDBRESULT CreateTable(CSIZE, PCCHAR = NULL, CSIZE = 0, CBYTE = MAX_OF(BYTE)) = 0;
		...
		VIRTUAL CDBRESULT DeleteFrom(CBYTE, CSIZE, CBOOL = TRUE) = 0;
		VIRTUAL CDBRESULT DeleteFrom(PCCHAR, CSIZE, CBOOL = TRUE) = 0;

		VIRTUAL CDBRESULT TruncateTable(CBYTE, CBOOL = TRUE) = 0;
		VIRTUAL CDBRESULT TruncateTable(PCCHAR, CBOOL = TRUE) = 0;
	...
	protected:
		...
		VIRTUAL CDBRESULT MoveTables(RCDWORD, RCLONG, CBOOL = TRUE) = 0;
