...
/* NOTE: DEFINE [ITTYBITTY_BASE_ONLY] TO INCLUDE ONLY THE BARE MINIMUM, SUCH AS BIT-TWIDDLING MACROS */
...
/* NOTE: DEFINE [ITTYBITTY_SLIM] TO EXCLUDE (MORE RESOURCE-DEMANDING) FULL-FEATURED FUNCTIONALITY */

#ifdef ITTYBITTY_SLIM
	#undef EXCLUDE_ITTYBITTY_BYTES
	#undef EXCLUDE_ITTYBITTY_REGISTERS
	#undef EXCLUDE_ITTYBITTY_GPIO
