...
MenUI::MenUI(PUINAVIGATIONCONTROLLER navigation, PUIDISPLAYCONTROLLER display,
		CBYTE childCount, PPIMENUITEM children, CBOOL useGlobalOptions)
	: Menu(childCount, children), _Navigation(navigation), _Display(display)
{
}

MenUI::MenUI(PUINAVIGATIONCONTROLLER navigation, PUIDISPLAYCONTROLLER display,
		CBYTE initMenuCapacity, CBOOL useGlobalOptions)
	: Menu(initMenuCapacity), _Navigation(navigation), _Display(display)
{
}
...
PUINAVIGATIONCONTROLLER MenUI::Navigation()
{
	return _Navigation;
}

PUIDISPLAYCONTROLLER MenUI::Display()
{
	return _Display;
}
